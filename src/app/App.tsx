...
function DroppableGroupHeader({
  ...
  return (
    <div
      ref={ref}
      className={`${className} ${
        isOver ? 'bg-[rgba(0,127,255,0.06)]' : 'bg-transparent'
      }`}
      style={style}
    >
      {children}
...
export default function App() {
  ...
  const anyDrawerOpen = isClientDrawerOpen || isDeliveryDrawerOpen || isPaymentDrawerOpen ||
    isGroupDrawerOpen || isOfferDescriptionDrawerOpen || isOfferMenuOpen || isOfferIssuesOpen ||
    isGroupEditDrawerOpen || Boolean(selectedProduct);

  return (
    <DndProvider backend={HTML5Backend}>
      <div className="h-screen bg-[#EDEEF1] flex flex-col overflow-hidden">
      {/* Global DnD Tooltip */}
      {dragTooltip && (
      ...
      <div
        className={`fixed top-0 left-0 right-0 bg-[#EDEEF1] transition-transform duration-300 ease-in-out ${isStatusDropdownOpen ? 'z-[52]' : 'z-40'}`}
        style={{
        ...
        <div className="px-3 pb-3 pt-1">
          <div className="flex gap-1.5 overflow-x-auto">
            <button
              ...
              className={`flex h-8 flex-shrink-0 items-center gap-1 rounded-full px-4 text-[13px] font-medium transition-colors ${
                hasClient
                  ? 'bg-[rgba(13,45,94,0.09)] text-[#222934] hover:bg-[rgba(13,45,94,0.13)]'
                  : 'bg-[rgba(0,127,255,0.10)] text-[#007FFF] hover:bg-[rgba(0,127,255,0.14)]'
              }`}
            >
            ...
            >
              ...
              <span>Доставки</span>
              {deliveriesCount > 0 && (
                <span className="flex h-[18px] min-w-[18px] items-center justify-center rounded-full bg-[rgba(13,45,94,0.10)] px-1 text-[11px] font-medium text-[rgba(13,45,94,0.56)]">
                  {deliveriesCount}
                </span>
              )}
      ...
      {pinnedGroup && (
        <DroppableGroupHeader
          ...
          className={`fixed left-0 right-0 border-b border-[rgba(13,45,94,0.08)] bg-[#EDEEF1] transition-[top] ${anyDrawerOpen ? 'z-[30]' : 'z-50'}`}
          ...
          <div className="px-4 py-0">
            <div className="flex h-9 items-center gap-2">
              <button
                ...
                className="flex min-w-0 flex-1 items-center gap-1.5 rounded-md px-0 text-left focus:outline-none"
                aria-label={`Открыть список групп. Текущая группа ${pinnedGroup.name}`}
              >
                <h3 className="truncate text-[11px] font-semibold uppercase tracking-[0.07em] text-[rgba(13,45,94,0.40)]">
                  {pinnedGroup.name}
                </h3>
                <ChevronDown className="h-3 w-3 flex-shrink-0 text-[rgba(13,45,94,0.30)]" />
              </button>
              <div className="flex-shrink-0 text-[11px] font-medium text-[rgba(13,45,94,0.30)]">
              ...
              <button
                ...
                className="flex h-7 w-7 flex-shrink-0 items-center justify-center rounded-md hover:bg-[rgba(13,45,94,0.06)]"
                aria-label={`Меню группы ${pinnedGroup.name}`}
              >
                <MoreVertical className="w-4 h-4 text-[rgba(13,45,94,0.35)]" />
              </button>
            </div>
          </div>
        </DroppableGroupHeader>
        ...
        <section>
          <div>
            {visibleGroups.map((group, groupIndex) => (
              ...
              >
                ...
                <DroppableGroupHeader
                  ...
                  onProductDrop={moveProductToGroup}
                  setDragTooltip={setDragTooltip}
                  className={`${pinnedGroupId === group.id ? 'pointer-events-none opacity-0' : ''}`}
                >
                  <div className="px-4 pt-6 pb-2">
                    <div className="flex h-7 items-center gap-2">
                      <div className="flex min-w-0 flex-1 items-center gap-2">
                        ...
                        <span className="flex-shrink-0 text-[11px] font-medium text-[rgba(13,45,94,0.28)]">
                      ...
                      <div className="relative flex-shrink-0">
                        <button
                          ...
                          className="flex h-7 w-7 items-center justify-center rounded-md hover:bg-[rgba(13,45,94,0.07)]"
                ...
                {group.description && (
                  <p className="px-4 pb-2 pt-1 text-[13px] text-[rgba(13,45,94,0.50)] leading-[18px]">
                    {group.description}
                  </p>
                )}
                ...
                <div>
                    {group.products.length === 0 && (
                      <div className="bg-white px-4 py-5 border-b border-[rgba(13,45,94,0.07)]">
                        <span className="text-[13px] text-[rgba(13,45,94,0.28)]">В группе нет товаров</span>
                      </div>
                    )}
                      ...
                      <div key={product.id}>
                        ...
                        >
                          <SwipeableRow onDelete={() => {
                            ...
                            <div className="bg-white px-4 py-4 border-b border-[rgba(13,45,94,0.07)]">
                    ...
                    <div className="px-4 pt-3 pb-1 flex items-center justify-between">
                      <div className="flex flex-col gap-0.5">
                        {calculateGroupDiscount(group) > 0 && (
                          <span className="text-[12px] text-[rgba(13,45,94,0.44)]">
                            скидка −{calculateGroupDiscount(group).toFixed(1)}%
                          </span>
                        )}
                      </div>
                      <span className="text-[18px] font-semibold text-[#222934]" style={{ fontFeatureSettings: "'lnum', 'tnum'" }}>
                    ...
                    <div className="px-4 pb-5 pt-2 flex gap-3">
                      <button className="flex items-center gap-1.5 text-[13px] font-medium text-[#007FFF] hover:opacity-70 transition-opacity">
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                          <path d="M7 1V13M1 7H13" stroke="#007FFF" strokeWidth="1.5" strokeLinecap="round"/>
                        </svg>
                        Выбрать позиции
                      </button>
                      <button
                        onClick={() => addNewProduct(group.id)}
                        className="flex items-center gap-1.5 text-[13px] font-medium text-[#007FFF] hover:opacity-70 transition-opacity"
                      >
                        <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
                          <path d="M7 1V13M1 7H13" stroke="#007FFF" strokeWidth="1.5" strokeLinecap="round"/>
                        </svg>
            ...
            <div className="px-4 py-4">
              <button
                onClick={addNewGroup}
                className="flex items-center gap-1.5 text-[13px] font-medium text-[rgba(13,45,94,0.40)] hover:text-[#007FFF] transition-colors"
              >
                <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
      ...
      {isClientDrawerOpen && (
        <>
          ...
          />
          <div className="fixed inset-x-0 bottom-0 z-50 flex max-h-[72vh] flex-col rounded-t-2xl bg-white">
              ...
              <div className="space-y-2">
                ...
                <div className="relative">
                  <input
                    ...
                    onChange={(e) => {
                      setClientDraft(prev => ({ ...prev, name: e.target.value }));
                      setShowNameSuggestions(true);
                    }}
                    onFocus={() => setShowNameSuggestions(true)}
                    onBlur={() => setTimeout(() => setShowNameSuggestions(false), 150)}
                    className="h-11 w-full rounded-[12px] border border-[rgba(13,45,94,0.12)] bg-white px-3 text-[15px] font-medium text-[#222934] outline-none transition-shadow focus:ring-2 focus:ring-[#007FFF]/20"
                    placeholder="ФИО"
                  />
                  {showNameSuggestions && (() => {
                    const q = clientDraft.name.trim().toLowerCase();
                    ...
                    return suggestions.length > 0 ? (
                      <div className="absolute left-0 right-0 top-[46px] z-10 overflow-hidden rounded-[12px] border border-[rgba(13,45,94,0.10)] bg-white shadow-[0_4px_16px_rgba(13,45,94,0.12)]">
                        {suggestions.map((client, i) => (
                          <button
                            ...
                            className={`flex w-full items-center gap-3 px-3 py-2.5 text-left transition-colors hover:bg-[rgba(13,45,94,0.04)] ${
                              i > 0 ? 'border-t border-[rgba(13,45,94,0.06)]' : ''
                            }`}
                          >
                            <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full bg-[#EDF5FF] text-[12px] font-semibold text-[#007FFF]">
                              {client.name.split(' ').map(w => w[0]).slice(0, 2).join('')}
                            </div>
                            <div className="min-w-0 flex-1">
                              <div className="text-[14px] font-medium text-[#222934]">{client.name}</div>
                              {client.company && (
                                <div className="text-[12px] text-[rgba(13,45,94,0.48)] truncate">{client.company}</div>
                              )}
                            </div>
                          </button>
                        ))}
                ...
                <button
                  ...
                  className="mt-1 flex h-11 w-full items-center justify-center rounded-[12px] bg-[#007FFF] px-4 text-[15px] font-semibold text-white disabled:opacity-40 transition-opacity"
      ...
      {isOfferDescriptionDrawerOpen && (
        <>
          ...
          />
          <div className="fixed inset-x-0 bottom-0 z-50 flex max-h-[92vh] flex-col rounded-t-2xl bg-white">
      ...
      {isOfferMenuOpen && (
        <>
          ...
          />
          <div className="fixed inset-x-0 bottom-0 z-50 max-h-[44vh] flex flex-col rounded-t-2xl bg-white">
            <div className="px-4 py-3 border-b border-[rgba(13,45,94,0.08)]">
              <div className="w-12 h-1 bg-[rgba(13,45,94,0.16)] rounded-full mx-auto mb-3" />
              <div className="flex items-center justify-between gap-3">
      ...
      {isOfferIssuesOpen && (
        <>
          ...
          />
          <div className="fixed inset-x-0 bottom-0 z-50 max-h-[72vh] flex flex-col rounded-t-2xl bg-white">
            <div className="px-4 py-3 border-b border-[rgba(13,45,94,0.08)]">
              <div className="w-12 h-1 bg-[rgba(13,45,94,0.16)] rounded-full mx-auto mb-3" />
